...
pull. No more advanced features need to be used. If not familiar with that,
contact the lecture (early on!) to figure it out.
...
for the compila 23 compiler. Inside the top-level compila directory, which
...
is useful:
  ...
  [- [[https://mattermost.uio.no/ifi-undervisning/channels/inf5110][mattermost]] : I think this year this channel was not openend]
