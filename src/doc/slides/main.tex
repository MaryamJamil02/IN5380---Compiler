...
\def\mydate{Spring 2021}        %% what for
\usetheme{default}
\usecolortheme{}
\usefonttheme{}
\useinnertheme{}
...
\begin{frame}[label={sec:org238d6fc}]{Oblig 1}
\begin{itemize}
...
\begin{frame}[label={sec:orgac2c765}]{Goal (of oblig 1)}
\begin{block}{Parsing}
...
\begin{frame}[label={sec:org9dba48c}]{Learning outcomes}
\begin{itemize}
...
\begin{frame}[label={sec:orgafaa4cd}]{Compila language at a glance}
...
\begin{frame}[label={sec:org37f2a8f},plain]{Another glance}

\lstinputlisting[basicstyle=\scriptsize,emph={begin,end,in, proc,program,var,return,struct}]{code/swap.cmp}
\end{frame}


\begin{frame}[label={sec:org3a6a6a8},plain]{Grammar (1): declarations}
...
\begin{frame}[label={sec:org67fa0a3},plain]{Grammar (2): expressions, statements, etc.}
...
\begin{frame}[label={sec:org055bfdb},plain]{Grammar (3): statements and types}
...
\section{Tools}
\label{sec:org58da95e}

\begin{frame}[label={sec:orgd4fcde4},fragile]{Tools: JFlex}
 \begin{itemize}
...
\begin{frame}[label={sec:org35236e0}]{Sample lex code}
\includegraphics[width=\textwidth]{figures/snaps/lexcode}
\end{frame}



\begin{frame}[label={sec:orga0f06a3},fragile]{CUP: Construction of useful parsers (for Java)}
 \begin{itemize}
...
\begin{frame}[label={sec:orga9c6437}]{Sample CUP code}
\includegraphics[width=\textwidth]{figures/snaps/cupcode}
\end{frame}



\begin{frame}[label={sec:org0150001},fragile]{Build tool: ant}
...
\begin{frame}[label={sec:org486db43}]{AST data structure}
...
\begin{frame}[label={sec:org41a36ba},fragile]{Overview over the directory + first steps}
 \begin{itemize}
...
\begin{frame}[label={sec:orgcac782c}]{Building: putting it together}
...
\section{Official}
\label{sec:orgf38b842}

\begin{frame}[label={sec:org17fd4a4},fragile]{Deadline}
...
\begin{frame}[label={sec:orgd9b8343},fragile]{Deliverables}
 \begin{itemize}
...
\begin{frame}[label={sec:org660faa8}]{Deliverables}
...
\begin{frame}[label={sec:org1bcdc7c},fragile]{Hand-in procedure}
 \begin{itemize}
