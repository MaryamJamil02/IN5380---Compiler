...
\begin{frame}[label={sec:orgeee896e}]{Learning outcomes}
\begin{itemize}
...
\begin{frame}[label={sec:org937cf6a}]{Compila language at a glance}
...
\begin{frame}[label={sec:org43314e5},plain]{Another glance}

\lstinputlisting[basicstyle=\scriptsize,emph={begin,end,in, proc,program,var,return,struct}]{code/swap.cmp}
\end{frame}


\begin{frame}[label={sec:orgf9e5ac8},plain]{Grammar (1): declarations}
...
\begin{frame}[label={sec:org568112e},plain]{Grammar (2): expressions, statements, etc.}
...
\begin{frame}[label={sec:org3b019f6},plain]{Grammar (3): statements and types}
...
\section{Tools}
\label{sec:orgfbf73c3}

\begin{frame}[label={sec:orgceac3b7},fragile]{Tools: JFlex}
 \begin{itemize}
...
\begin{frame}[label={sec:orge9d48f5}]{Sample lex code}
\includegraphics[width=\textwidth]{figures/snaps/lexcode}
\end{frame}



\begin{frame}[label={sec:orgb1f299b},fragile]{CUP: Construction of useful parsers (for Java)}
 \begin{itemize}
...
\begin{frame}[label={sec:org91152c0}]{Sample CUP code}
\includegraphics[width=\textwidth]{figures/snaps/cupcode}
\end{frame}



\begin{frame}[label={sec:org5a66a4e},fragile]{Build tool: ant}
...
\begin{frame}[label={sec:org7124c1d}]{AST data structure}
...
\begin{frame}[label={sec:orgc7925fc},fragile]{Overview over the directory + first steps}
 \begin{itemize}
...
\begin{frame}[label={sec:org827fe7c},fragile]{Deliverables}
 \begin{itemize}
...
\begin{frame}[label={sec:org695dac7}]{Deliverables}
