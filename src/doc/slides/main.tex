...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org0529d20}]{Learning outcomes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd7a3899}]{Sample lex code}
\includegraphics[width=\textwidth]{figures/snaps/lexcode}
\end{frame}
\begin{frame}[label={sec:org77512f0},fragile]{CUP: Construction of useful parsers (for Java)}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd1ee272}]{Sample CUP code}
\includegraphics[width=\textwidth]{figures/snaps/cupcode}
\end{frame}
\begin{frame}[label={sec:org99a2992},fragile]{Build tool: ant}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgc99075f}]{AST data structure}

\begin{center}
 \includegraphics[width=0.8\textwidth]{figures/snaps/astclasses}
\end{center}
\end{frame}
\begin{frame}[label={sec:org786e0b5},fragile]{Overview over the directory + first steps}
 \begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org3a3dda3}]{Building: putting it together}
