...
\begin{frame}[label={sec:orgf6328f4}]{Learning outcomes}
\begin{itemize}
...
\begin{frame}[label={sec:orgd8a1435}]{Compila language at a glance}
...
\begin{frame}[label={sec:org8add5ff},plain]{Another glance}

\lstinputlisting[basicstyle=\scriptsize,emph={begin,end,in, proc,program,var,return,struct}]{code/swap.cmp}
\end{frame}


\begin{frame}[label={sec:org65a6c09},plain]{Grammar (1): declarations}
...
\begin{frame}[label={sec:org329bd9f},plain]{Grammar (2): expressions, statements, etc.}
...
\begin{frame}[label={sec:orga26706a},plain]{Grammar (3): statements and types}
...
\section{Tools}
\label{sec:org8ed7ecf}

\begin{frame}[label={sec:orge1d3680},fragile]{Tools: JFlex}
 \begin{itemize}
...
\begin{frame}[label={sec:orgc1385a4}]{Sample lex code}
\includegraphics[width=\textwidth]{figures/snaps/lexcode}
\end{frame}



\begin{frame}[label={sec:org1b41b3a},fragile]{CUP: Construction of useful parsers (for Java)}
 \begin{itemize}
...
\begin{frame}[label={sec:org0f7b062}]{Sample CUP code}
\includegraphics[width=\textwidth]{figures/snaps/cupcode}
\end{frame}



\begin{frame}[label={sec:orgf4a789c},fragile]{Build tool: ant}
...
\begin{frame}[label={sec:org9d0bdb9}]{AST data structure}
...
\begin{frame}[label={sec:org83090a0},fragile]{Overview over the directory + first steps}
 \begin{itemize}
...
\begin{frame}[label={sec:org7597188},fragile]{Deliverables}
 \begin{itemize}
...
\begin{frame}[label={sec:org3bbd609}]{Deliverables}
