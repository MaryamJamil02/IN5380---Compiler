...
\maketitle
\chapter{Oblig 1}
\label{sec:org19e5e01}



\section{Compila 18}
\label{sec:org8e37bd3}

\begin{frame}[label={sec:orgb5c4a2c}]{Oblig 1}
\begin{itemize}
...
\begin{frame}[label={sec:org98d209a}]{Goal (of oblig 1)}
\begin{block}{Parsing}
...
\begin{frame}[label={sec:org8d23826}]{Learning outcomes}
\begin{itemize}
...
\begin{frame}[label={sec:org244e638}]{Compila language at a glance}
...
\begin{frame}[plain,label={sec:org716e9ef}]{Another glance}

\lstinputlisting[basicstyle=\scriptsize]{code/swap.cmp}
\end{frame}


\begin{frame}[plain,label={sec:org83cf2d5}]{Grammar (1): declarations}
...
\begin{frame}[plain,label={sec:org4c7b985}]{Grammar (2): declarations}
...
\begin{frame}[plain,label={sec:org35fbffb}]{Grammar (3): statements and types}
...
\section{Tools}
\label{sec:orgb49ab32}

\begin{frame}[fragile,label={sec:org4dbe6be}]{Tools: JFlex}
 \begin{itemize}
...
\begin{frame}[label={sec:orgf1b727e}]{Sample lex code}
\includegraphics[width=\textwidth]{figures/snaps/lexcode}
\end{frame}



\begin{frame}[fragile,label={sec:orgd5b3444}]{CUP: Construction of useful parsers (for Java)}
 \begin{itemize}
...
\begin{frame}[label={sec:orgdd0274b}]{Sample CUP code}
\includegraphics[width=\textwidth]{figures/snaps/cupcode}
\end{frame}



\begin{frame}[fragile,label={sec:orge4531ef}]{Build tool: ant}
...
\begin{frame}[label={sec:org38a0cd8}]{AST data structure}
...
\begin{frame}[label={sec:org2c1b440}]{Provides source code}
...
\begin{frame}[label={sec:org247ff93}]{Building: putting it together}
...
\section{Official}
\label{sec:org8d0d279}

\begin{frame}[fragile,label={sec:orgffb3065}]{Deadline}
...
\begin{frame}[fragile,label={sec:org33c586e}]{Deliverables}
 \begin{itemize}
...
\begin{frame}[label={sec:org2de6a4f}]{Deliverables}
...
\begin{frame}[fragile,label={sec:org775fa6f}]{Hand-in procedure}
 \begin{itemize}
...
\chapter{Oblig2}
\label{sec:orgfdca217}


\begin{frame}[fragile,label={sec:orgb131027}]{Goal}
 \begin{enumerate}
...
\begin{frame}[label={sec:orgef855e0}]{Last time (O1)}
...
\begin{frame}[label={sec:org8d1296b}]{Learning outcome}
\begin{itemize}
...
\begin{frame}[label={sec:orgd14cfa8}]{Semantic analysis \& type checking}
\begin{itemize}
...
\begin{frame}[label={sec:orgae0f2f2}]{Another glance at compila18}
...
\begin{frame}[fragile,plain,label={sec:org44190aa}]{Type checking for conditionals}
 \begin{itemize}
...
\begin{frame}[fragile,plain,label={sec:org53c541d}]{Type checking: assignments}
 \lstset{language=java,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\begin{frame}[fragile,label={sec:org13812ca}]{Code generation}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:org94a28d0}]{Code generation: limitations}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:org018ef1e}]{Testing}
 \begin{itemize}
...
\begin{frame}[label={sec:orgfbee22e}]{Provided source code}
\begin{itemize}
