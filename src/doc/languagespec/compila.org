...
#+TEXINFO_DIR_TITLE:
#+TEXINFO_DIR_DESC:
#+TEXINFO_PRINTED_TITLE: Compila 21
#+DESCRIPTION: Compila 21 language specification
#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="compilastyle.css" />
#+HTML_HEAD_EXTRA: <h1> Compila 21 language specification</h1>
...
of the language /Compila 21/.  The dynamic semantics, i.e., the description
