...
* Egne notater
Ettersom vi skriver i Haskell istedenfor Java, kan vi ikke benytte alle Martin sine ressurser. For oblig 1 vil vi bruke Alex istedenfor JFlex, og Happy istedenfor CUP. Istedenfor Ant bruker vi Stack.

Noe av det råeste med Happy er at det kan [[https://haskell-happy.readthedocs.io/en/latest/using.html#using-precedences]["fjerne" tvetydighet]] ved å binde presedens til literals, som gjør at vi slipper å endre så mye av den nåværende grammatikken!

Lexer: https://serokell.io/blog/lexing-with-alex \\
Parser: https://serokell.io/blog/parsing-with-happy

Bør nevne at vi /vet/ at grammatikken er tvetydig, og at vi har valgt å bruke Happy's presedens-greier (nevnt over) istedenfor å massere grammatikken. Men at vi også vet hva/hvordan vi hadde massert den om vi måtte.
