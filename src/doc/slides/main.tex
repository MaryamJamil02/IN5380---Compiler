...
\label{sec:orgce20fee}



\section{Compila 20}
\label{sec:org2692080}

\begin{frame}[label={sec:orgcf1c707}]{Oblig 1}
\begin{itemize}
...
\begin{frame}[label={sec:orga5edd38}]{Goal (of oblig 1)}
\begin{block}{Parsing}
...
\begin{frame}[label={sec:org3439ff2}]{Learning outcomes}
\begin{itemize}
...
\begin{frame}[label={sec:org45db4f1}]{Compila language at a glance}
...
\begin{frame}[label={sec:orgcff6f83},plain]{Another glance}

\lstinputlisting[basicstyle=\scriptsize,emph={begin,end,in, proc,program,var,return,struct}]{code/swap.cmp}
\end{frame}


\begin{frame}[label={sec:org5c1d649},plain]{Grammar (1): declarations}
...
\begin{frame}[label={sec:org55d7885},plain]{Grammar (2): expressions, statements, etc.}
...
\begin{frame}[label={sec:orgc028f9f},plain]{Grammar (3): statements and types}
...
\section{Tools}
\label{sec:org350f67e}

\begin{frame}[label={sec:org278bdb1},fragile]{Tools: JFlex}
 \begin{itemize}
...
\begin{frame}[label={sec:org8b552ea}]{Sample lex code}
\includegraphics[width=\textwidth]{figures/snaps/lexcode}
\end{frame}



\begin{frame}[label={sec:org42c8079},fragile]{CUP: Construction of useful parsers (for Java)}
 \begin{itemize}
...
\begin{frame}[label={sec:org9edaf5f}]{Sample CUP code}
\includegraphics[width=\textwidth]{figures/snaps/cupcode}
\end{frame}



\begin{frame}[label={sec:org1b895eb},fragile]{Build tool: ant}
...
\begin{frame}[label={sec:org55153a5}]{AST data structure}
...
\begin{frame}[label={sec:org97fa0cf},fragile]{Overview over the directory + first steps}
 \begin{itemize}
...
\begin{frame}[label={sec:org2ccbe75}]{Building: putting it together}
...
\section{Official}
\label{sec:org825f952}

\begin{frame}[label={sec:orgab10eed},fragile]{Deadline}
...
\begin{frame}[label={sec:orgf08d61e},fragile]{Deliverables}
 \begin{itemize}
...
\begin{frame}[label={sec:org8034909}]{Deliverables}
...
\begin{frame}[label={sec:orgbf36586},fragile]{Hand-in procedure}
 \begin{itemize}
