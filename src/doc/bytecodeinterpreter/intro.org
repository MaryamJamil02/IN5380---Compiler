...
~bytecode.type.*~.  The instructions in the first package are concrete
subclasses of the abstract [[srcbytecode:./instructions/Instruction.java][~Instruction~]] class.
