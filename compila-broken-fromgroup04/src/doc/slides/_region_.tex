\message{ !name(main.tex)}% Created 2022-03-29 Tue 11:59
...
\maketitle
\chapter{Intro}
\label{sec:orgd256aea}
\begin{frame}[label={sec:orga57bdc3},fragile]{Goal}
 \begin{enumerate}
...
\begin{frame}[label={sec:org3ccd15f}]{Last time (O1)}
...
\begin{frame}[label={sec:org8433d86}]{Learning outcome}
\begin{itemize}
...
\label{sec:org593f7b6}
\begin{frame}[label={sec:org970d752}]{Semantic analysis \& type checking}
\begin{itemize}
...
\begin{frame}[label={sec:orgbf50b97}]{Another glance at compila22}
...
\begin{frame}[label={sec:org815b7c5},fragile,plain]{Type checking for conditionals}
 \begin{itemize}
...
\begin{frame}[label={sec:orgaad8a52},fragile,plain]{Type checking: assignments}
 \lstset{language=java,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:org731c862}
\begin{frame}[label={sec:orga3bda87},fragile]{Code generation}
 \begin{itemize}
...
\begin{frame}[label={sec:orgaee178c},fragile]{Code generation: limitations}
 \begin{itemize}
...
\begin{frame}[label={sec:orgf5c6b4a},fragile,plain]{Code generation: creating a procedure}
 \lstset{language=java,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\begin{frame}[label={sec:orgf1f098a}]{Code generation: assignment}
\begin{center}
...
\chapter{Testing}
\label{sec:org6d4ebda}
\begin{frame}[label={sec:orgaf052bb},fragile]{Testing}
 \begin{itemize}
...
\label{sec:orgb2ebfa3}
\begin{frame}[label={sec:org276126b}]{Provided source code (patch)}
...
\begin{frame}[label={sec:org6089fca}]{Provided documentation (patch)}
...
\begin{frame}[label={sec:orgf4e28a9},fragile]{Relevant directories}
 \begin{itemize}
\item Java
...
\begin{frame}[label={sec:orgf06b2c1},fragile]{Deadline}
