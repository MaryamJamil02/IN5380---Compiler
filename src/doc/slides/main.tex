...
\maketitle
\chapter{Oblig 1}
\label{sec:org562e695}



\section{Compila 18}
\label{sec:orga22ab33}

\begin{frame}[label={sec:orgda10dee}]{Oblig 1}
\begin{itemize}
...
\begin{frame}[label={sec:org8d8452c}]{Goal (of oblig 1)}
\begin{block}{Parsing}
...
\begin{frame}[label={sec:orgd0f980d}]{Learning outcomes}
\begin{itemize}
...
\begin{frame}[label={sec:org4c873e7}]{Compila language at a glance}
...
\begin{frame}[plain,label={sec:org7953826}]{Another glance}

\lstinputlisting[basicstyle=\scriptsize]{code/swap.cmp}
\end{frame}


\begin{frame}[plain,label={sec:orgb6bc256}]{Grammar (1): declarations}
...
\begin{frame}[plain,label={sec:org2505b32}]{Grammar (2): declarations}
...
\begin{frame}[plain,label={sec:org116b14a}]{Grammar (3): statements and types}
...
\section{Tools}
\label{sec:org5774b38}

\begin{frame}[fragile,label={sec:org18e6ed9}]{Tools: JFlex}
 \begin{itemize}
...
\begin{frame}[label={sec:org9cace16}]{Sample lex code}
\includegraphics[width=\textwidth]{figures/snaps/lexcode}
\end{frame}



\begin{frame}[fragile,label={sec:org4a110f3}]{CUP: Construction of useful parsers (for Java)}
 \begin{itemize}
...
\begin{frame}[label={sec:org567a09b}]{Sample CUP code}
\includegraphics[width=\textwidth]{figures/snaps/cupcode}
\end{frame}



\begin{frame}[fragile,label={sec:org6b66b8f}]{Build tool: ant}
...
\begin{frame}[label={sec:org7edc78b}]{AST data structure}
...
\begin{frame}[label={sec:orgee26d7b}]{Provides source code}
...
\begin{frame}[label={sec:orgbf67953}]{Building: putting it together}
...
\section{Official}
\label{sec:org49620f9}

\begin{frame}[fragile,label={sec:org227fb06}]{Deadline}
...
\begin{frame}[fragile,label={sec:orgad0b3cd}]{Deliverables}
 \begin{itemize}
...
\begin{frame}[label={sec:org2bd12b4}]{Deliverables}
...
\begin{frame}[fragile,label={sec:org4dd9b69}]{Hand-in procedure}
 \begin{itemize}
...
\chapter{Oblig2}
\label{sec:orga7ffd44}


\begin{frame}[fragile,label={sec:org13b80bb}]{Goal}
 \begin{enumerate}
...
\begin{frame}[label={sec:org456050a}]{Last time (O1)}
...
\begin{frame}[label={sec:org56bd839}]{Learning outcome}
\begin{itemize}
...
\begin{frame}[label={sec:org33e740a}]{Semantic analysis \& type checking}
\begin{itemize}
...
\begin{frame}[label={sec:org8d135af}]{Another glance at compila18}
...
\begin{frame}[fragile,plain,label={sec:org0723e44}]{Type checking for conditionals}
 \begin{itemize}
...
\begin{frame}[fragile,plain,label={sec:org961a131}]{Type checking: assignments}
 \lstset{language=java,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\begin{frame}[fragile,label={sec:orgeabb136}]{Code generation}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:org35db54b}]{Code generation: limitations}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:org61ee943}]{Testing}
 \begin{itemize}
...
\begin{frame}[label={sec:org90d3947}]{Provided source code}
\begin{itemize}
...
\begin{frame}[fragile,label={sec:orge9c6f67}]{Provided source code}
...
\begin{frame}[fragile,label={sec:org8430b05}]{Deadline}
 \begin{alertblock}{Deadline}
11th May  2018
\end{alertblock}
