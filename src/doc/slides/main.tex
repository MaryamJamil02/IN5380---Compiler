...
\begin{frame}[label={sec:org1df2ca0}]{Learning outcomes}
\begin{itemize}
...
\begin{frame}[label={sec:org910e8fa}]{Compila language at a glance}
...
\begin{frame}[label={sec:orgc886aed},plain]{Another glance}

\lstinputlisting[basicstyle=\scriptsize,emph={begin,end,in, proc,program,var,return,struct}]{code/swap.cmp}
\end{frame}


\begin{frame}[label={sec:org9524e82},plain]{Grammar (1): declarations}
...
\begin{frame}[label={sec:org369e747},plain]{Grammar (2): expressions, statements, etc.}
...
\begin{frame}[label={sec:orgfabb4ae},plain]{Grammar (3): statements and types}
...
\section{Tools}
\label{sec:org4e083e8}

\begin{frame}[label={sec:org3a79230},fragile]{Tools: JFlex}
 \begin{itemize}
...
\begin{frame}[label={sec:orgf988377}]{Sample lex code}
\includegraphics[width=\textwidth]{figures/snaps/lexcode}
\end{frame}



\begin{frame}[label={sec:org73d1fc4},fragile]{CUP: Construction of useful parsers (for Java)}
 \begin{itemize}
...
\begin{frame}[label={sec:org17b96cd}]{Sample CUP code}
\includegraphics[width=\textwidth]{figures/snaps/cupcode}
\end{frame}



\begin{frame}[label={sec:orgac9836b},fragile]{Build tool: ant}
...
\begin{frame}[label={sec:org5f18fba}]{AST data structure}
...
\begin{frame}[label={sec:org52d7c77},fragile]{Overview over the directory + first steps}
 \begin{itemize}
...
\begin{frame}[label={sec:org9f76786},fragile]{Deliverables}
 \begin{itemize}
...
\begin{frame}[label={sec:org5578508}]{Deliverables}
