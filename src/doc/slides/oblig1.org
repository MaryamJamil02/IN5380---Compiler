...
Determine if programs written in /Compila 25/ are syntactically correct: 
...
*** Provided source code                             :B_frame:ARCHIVE:ignore:
    :PROPERTIES:
    :BEAMER_env: frame
    :END:
...
-  [[https://github.uio.no]] resp.
   [[https://github.uio.no/compilerconstruction-inf5110/compila][https://github.uio.no/compilerconstruction-inf5110/compila25-xx]]

- you need

  - a login
  - send me emails that you want to do the obligs (+ potential partner)
