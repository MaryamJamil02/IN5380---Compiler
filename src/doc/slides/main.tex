...
\maketitle
\chapter{Oblig 1}
\label{sec:orgd0eee48}



\section{Compila 18}
\label{sec:org094c27c}

\begin{frame}[label={sec:org38c7ef5}]{Oblig 1}
\begin{itemize}
...
\begin{frame}[label={sec:org6698d92}]{Goal (of oblig 1)}
\begin{block}{Parsing}
...
\begin{frame}[label={sec:orgfd6c575}]{Learning outcomes}
\begin{itemize}
...
\begin{frame}[label={sec:org7f8e69f}]{Compila language at a glance}
...
\begin{frame}[plain,label={sec:org501b9f6}]{Another glance}

\lstinputlisting[basicstyle=\scriptsize]{code/swap.cmp}
\end{frame}


\begin{frame}[plain,label={sec:orgd8ae876}]{Grammar (1): declarations}
...
\begin{frame}[plain,label={sec:org8c622c3}]{Grammar (2): declarations}
...
\begin{frame}[plain,label={sec:org7ed9752}]{Grammar (3): statements and types}
...
\section{Tools}
\label{sec:orgb294bf2}

\begin{frame}[fragile,label={sec:org91e74af}]{Tools: JFlex}
 \begin{itemize}
...
\begin{frame}[label={sec:org397a11f}]{Sample lex code}
\includegraphics[width=\textwidth]{figures/snaps/lexcode}
\end{frame}



\begin{frame}[fragile,label={sec:org96e2bc7}]{CUP: Construction of useful parsers (for Java)}
 \begin{itemize}
...
\begin{frame}[label={sec:orgb970b00}]{Sample CUP code}
\includegraphics[width=\textwidth]{figures/snaps/cupcode}
\end{frame}



\begin{frame}[fragile,label={sec:org8b17573}]{Build tool: ant}
...
\begin{frame}[label={sec:orgceada47}]{AST data structure}
...
\begin{frame}[label={sec:org723af4f}]{Provides source code}
...
\begin{frame}[label={sec:orgd60f702}]{Building: putting it together}
...
\section{Official}
\label{sec:org3cb27d5}

\begin{frame}[fragile,label={sec:orga8f0db0}]{Deadline}
...
\begin{frame}[fragile,label={sec:org4ae9e4d}]{Deliverables}
 \begin{itemize}
...
\begin{frame}[label={sec:orge69c717}]{Deliverables}
...
\begin{frame}[fragile,label={sec:org49e1a86}]{Hand-in procedure}
 \begin{itemize}
...
\chapter{Oblig2}
\label{sec:org8fcaa33}


\begin{frame}[fragile,label={sec:org9d3cba3}]{Goal}
 \begin{enumerate}
...
\begin{frame}[label={sec:orgbff3b84}]{Last time (O1)}
...
\begin{frame}[label={sec:org3d32cc5}]{Learning outcome}
\begin{itemize}
...
\begin{frame}[label={sec:org271337b}]{Semantic analysis \& type checking}
\begin{itemize}
...
\begin{frame}[label={sec:org2f7e0e4}]{Another glance at compila18}
...
\begin{frame}[fragile,plain,label={sec:orgc28411a}]{Type checking for conditionals}
 \begin{itemize}
