...
#+TEXINFO_DIR_TITLE:
#+TEXINFO_DIR_DESC:
#+TEXINFO_PRINTED_TITLE: Compila 20 (version for Oblig 1, not yet activated)
#+DESCRIPTION: Compila 20 language specification
#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="compilastyle.css" />
#+HTML_HEAD_EXTRA: <h1> Compila 20 language specification</h1>
...
of the language /Compila 20/.  The dynamic semantics, i.e., the description
