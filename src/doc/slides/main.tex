...
\begin{frame}[label={sec:org5c433ab}]{Learning outcomes}
\begin{itemize}
...
\begin{frame}[label={sec:org640639c}]{Compila language at a glance}
...
\begin{frame}[label={sec:orgf2e82dd},plain]{Another glance}

\lstinputlisting[basicstyle=\scriptsize,emph={begin,end,in, proc,program,var,return,struct}]{code/swap.cmp}
\end{frame}


\begin{frame}[label={sec:orgd20262d},plain]{Grammar (1): declarations}
...
\begin{frame}[label={sec:orge2af2b4},plain]{Grammar (2): expressions, statements, etc.}
...
\begin{frame}[label={sec:org533f6a2},plain]{Grammar (3): statements and types}
...
\section{Tools}
\label{sec:org207f05b}

\begin{frame}[label={sec:orga86d952},fragile]{Tools: JFlex}
 \begin{itemize}
...
\begin{frame}[label={sec:orga8c771f}]{Sample lex code}
\includegraphics[width=\textwidth]{figures/snaps/lexcode}
\end{frame}



\begin{frame}[label={sec:org3c88867},fragile]{CUP: Construction of useful parsers (for Java)}
 \begin{itemize}
...
\begin{frame}[label={sec:org9a0d976}]{Sample CUP code}
\includegraphics[width=\textwidth]{figures/snaps/cupcode}
\end{frame}



\begin{frame}[label={sec:orgfb047c6},fragile]{Build tool: ant}
...
\begin{frame}[label={sec:org98461a2}]{AST data structure}
...
\begin{frame}[label={sec:org1a6d778},fragile]{Overview over the directory + first steps}
 \begin{itemize}
...
\begin{frame}[label={sec:orgb6a930f},fragile]{Deliverables}
 \begin{itemize}
...
\begin{frame}[label={sec:org5994841}]{Deliverables}
