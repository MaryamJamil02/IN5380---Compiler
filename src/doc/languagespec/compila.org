...
#+TEXINFO_DIR_TITLE:
#+TEXINFO_DIR_DESC:
#+TEXINFO_PRINTED_TITLE: Compila 23
#+DESCRIPTION: Compila 23 language specification
#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="compilastyle.css" />
#+HTML_HEAD_EXTRA: <h1> Compila 23 language specification</h1>
...
of the language /Compila 23/.  The dynamic semantics, i.e., the description
