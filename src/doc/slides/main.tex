...
\maketitle
\section{Compila 22}
\label{sec:orge8889e0}

\begin{frame}[label={sec:orgf82e8ef}]{Oblig 1}
\begin{itemize}
...
\begin{frame}[label={sec:org927fc9a}]{Goal (of oblig 1)}
\begin{block}{Parsing}
...
\begin{frame}[label={sec:org7df3714}]{Learning outcomes}
\begin{itemize}
...
\begin{frame}[label={sec:org50ab4eb}]{Compila language at a glance}
...
\begin{frame}[label={sec:org7fa105b},plain]{Another glance}

\lstinputlisting[basicstyle=\scriptsize,emph={begin,end,in, proc,program,var,return,struct}]{code/swap.cmp}
\end{frame}


\begin{frame}[label={sec:org15f659d},plain]{Grammar (1): declarations}
...
\begin{frame}[label={sec:orge80f3ec},plain]{Grammar (2): expressions, statements, etc.}
...
\begin{frame}[label={sec:orgda5848b},plain]{Grammar (3): statements and types}
...
\section{Tools}
\label{sec:org8c8ee42}

\begin{frame}[label={sec:org117a1ac},fragile]{Tools: JFlex}
 \begin{itemize}
...
\begin{frame}[label={sec:orgeb829c6}]{Sample lex code}
\includegraphics[width=\textwidth]{figures/snaps/lexcode}
\end{frame}



\begin{frame}[label={sec:org2f1a5a6},fragile]{CUP: Construction of useful parsers (for Java)}
 \begin{itemize}
...
\begin{frame}[label={sec:org8b3c051}]{Sample CUP code}
\includegraphics[width=\textwidth]{figures/snaps/cupcode}
\end{frame}



\begin{frame}[label={sec:org20ce58b},fragile]{Build tool: ant}
...
\begin{frame}[label={sec:org99c436c}]{AST data structure}
...
\begin{frame}[label={sec:org45bbc53},fragile]{Overview over the directory + first steps}
 \begin{itemize}
...
\begin{frame}[label={sec:orgbcc4e7b}]{Building: putting it together}
...
\section{Official}
\label{sec:orgf249e47}

\begin{frame}[label={sec:org059d2f5},fragile]{Deadline}
...
\begin{frame}[label={sec:orgcb6785a},fragile]{Deliverables}
 \begin{itemize}
...
\begin{frame}[label={sec:org8237812}]{Deliverables}
...
\begin{frame}[label={sec:org361074b}]{Hand-in procedure}
\begin{itemize}
