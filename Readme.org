...
~compila<xxx>~.  Please: call it not something else, not ~Compila<xxx>~,
not ~COMPILA<xxx>~, not ~compila-<xxx>~. It makes uniform treatment of all
groups and automatic checks (perhaps via scripts) a tiny bit more easy.
